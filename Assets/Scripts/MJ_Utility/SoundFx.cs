...
public class SoundFx : MonoBehaviour
{
	...
	private void KillSoundFx()
	{
		...
		SoundSystem.Inst.soundCount[audioSource.clip.name]--;
		if(SoundSystem.Inst.soundCount[audioSource.clip.name] < 0)
        {
			SoundSystem.Inst.soundCount[audioSource.clip.name] = 0;
		}
	}
