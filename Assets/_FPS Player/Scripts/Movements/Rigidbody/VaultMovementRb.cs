...
public class VaultMovementRb : MovementRigidbodyType
{
    [SerializeField]
    ...
    public override void SetPlayerComponents(PlayerRigidbodyMovement move, PlayerInput input)
    {
    ...
    public override void Check(bool canInteract)
    {
        ...
        float movementAdjust = (Vector3.ClampMagnitude(movement.rb.velocity, 16f).magnitude / 16f);
